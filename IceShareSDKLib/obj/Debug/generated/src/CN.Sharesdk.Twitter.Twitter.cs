...
namespace CN.Sharesdk.Twitter {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='cn.sharesdk.twitter']/class[@name='Twitter']"
	[global::Android.Runtime.Register ("cn/sharesdk/twitter/Twitter", DoNotGenerateAcw=true)]
	public partial class Twitter : global::CN.Sharesdk.Framework.Platform {

		// Metadata.xml XPath class reference: path="/api/package[@name='cn.sharesdk.twitter']/class[@name='Twitter.ShareParams']"
		[global::Android.Runtime.Register ("cn/sharesdk/twitter/Twitter$ShareParams", DoNotGenerateAcw=true)]
		public new partial class ShareParams : global::CN.Sharesdk.Framework.Platform.ShareParams {

			internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("cn/sharesdk/twitter/Twitter$ShareParams", typeof (ShareParams));
			...
			// Metadata.xml XPath constructor reference: path="/api/package[@name='cn.sharesdk.twitter']/class[@name='Twitter.ShareParams']/constructor[@name='Twitter.ShareParams' and count(parameter)=0]"
			[Register (".ctor", "()V", "")]
		...
		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("cn/sharesdk/twitter/Twitter", typeof (Twitter));
		internal static new IntPtr class_ref {
			get {
				return _members.JniPeerType.PeerReference.Handle;
			}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='cn.sharesdk.twitter']/class[@name='Twitter']/constructor[@name='Twitter' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe Twitter ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
...
#pragma warning disable 0169
		...
		{
			global::CN.Sharesdk.Twitter.Twitter __this = global::Java.Lang.Object.GetObject<global::CN.Sharesdk.Twitter.Twitter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.HasShareCallback;
		}
#pragma warning restore 0169

		public override unsafe bool HasShareCallback {
			// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.twitter']/class[@name='Twitter']/method[@name='hasShareCallback' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public override unsafe string Name {
			// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.twitter']/class[@name='Twitter']/method[@name='getName' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		protected override unsafe int PlatformId {
			// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.twitter']/class[@name='Twitter']/method[@name='getPlatformId' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public override unsafe int Version {
			// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.twitter']/class[@name='Twitter']/method[@name='getVersion' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.twitter']/class[@name='Twitter']/method[@name='checkAuthorize' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='java.lang.Object']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.twitter']/class[@name='Twitter']/method[@name='doAuthorize' and count(parameter)=1 and parameter[1][@type='java.lang.String[]']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.twitter']/class[@name='Twitter']/method[@name='doCustomerProtocol' and count(parameter)=5 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='int'] and parameter[4][@type='java.util.HashMap&lt;java.lang.String, java.lang.Object&gt;'] and parameter[5][@type='java.util.HashMap&lt;java.lang.String, java.lang.String&gt;']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.twitter']/class[@name='Twitter']/method[@name='doShare' and count(parameter)=1 and parameter[1][@type='cn.sharesdk.framework.Platform.ShareParams']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.twitter']/class[@name='Twitter']/method[@name='filterFriendshipInfo' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='java.util.HashMap&lt;java.lang.String, java.lang.Object&gt;']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.twitter']/class[@name='Twitter']/method[@name='follow' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.twitter']/class[@name='Twitter']/method[@name='getBilaterals' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='java.lang.String']]"
...
#pragma warning disable 0169
		...
		static IntPtr n_GetFollowers_IILjava_lang_String_ (IntPtr jnienv, IntPtr native__this, int count, int page, IntPtr native_nextCursor)
		{
			global::CN.Sharesdk.Twitter.Twitter __this = global::Java.Lang.Object.GetObject<global::CN.Sharesdk.Twitter.Twitter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			string nextCursor = JNIEnv.GetString (native_nextCursor, JniHandleOwnership.DoNotTransfer);
			IntPtr __ret = global::Android.Runtime.JavaDictionary<string, global::Java.Lang.Object>.ToLocalJniHandle (__this.GetFollowers (count, page, nextCursor));
			return __ret;
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.twitter']/class[@name='Twitter']/method[@name='getFollowers' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='java.lang.String']]"
		[Register ("getFollowers", "(IILjava/lang/String;)Ljava/util/HashMap;", "GetGetFollowers_IILjava_lang_String_Handler")]
		protected override unsafe global::System.Collections.Generic.IDictionary<string, global::Java.Lang.Object> GetFollowers (int count, int page, string nextCursor)
		{
			const string __id = "getFollowers.(IILjava/lang/String;)Ljava/util/HashMap;";
			IntPtr native_nextCursor = JNIEnv.NewString (nextCursor);
			try {
				JniArgumentValue* __args = stackalloc JniArgumentValue [3];
				__args [0] = new JniArgumentValue (count);
				__args [1] = new JniArgumentValue (page);
				__args [2] = new JniArgumentValue (native_nextCursor);
				var __rm = _members.InstanceMethods.InvokeVirtualObjectMethod (__id, this, __args);
				return global::Android.Runtime.JavaDictionary<string, global::Java.Lang.Object>.FromJniHandle (__rm.Handle, JniHandleOwnership.TransferLocalRef);
			} finally {
				JNIEnv.DeleteLocalRef (native_nextCursor);
			}
		}
...
#pragma warning disable 0169
		...
		static IntPtr n_GetFollowings_IILjava_lang_String_ (IntPtr jnienv, IntPtr native__this, int count, int page, IntPtr native_nextCursor)
		{
			global::CN.Sharesdk.Twitter.Twitter __this = global::Java.Lang.Object.GetObject<global::CN.Sharesdk.Twitter.Twitter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			string nextCursor = JNIEnv.GetString (native_nextCursor, JniHandleOwnership.DoNotTransfer);
			IntPtr __ret = global::Android.Runtime.JavaDictionary<string, global::Java.Lang.Object>.ToLocalJniHandle (__this.GetFollowings (count, page, nextCursor));
			return __ret;
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.twitter']/class[@name='Twitter']/method[@name='getFollowings' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='java.lang.String']]"
		[Register ("getFollowings", "(IILjava/lang/String;)Ljava/util/HashMap;", "GetGetFollowings_IILjava_lang_String_Handler")]
		protected override unsafe global::System.Collections.Generic.IDictionary<string, global::Java.Lang.Object> GetFollowings (int count, int page, string nextCursor)
		{
...
#pragma warning disable 0169
		...
		static void n_GetFriendList_IILjava_lang_String_ (IntPtr jnienv, IntPtr native__this, int count, int page, IntPtr native_nextCursor)
		{
			global::CN.Sharesdk.Twitter.Twitter __this = global::Java.Lang.Object.GetObject<global::CN.Sharesdk.Twitter.Twitter> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			string nextCursor = JNIEnv.GetString (native_nextCursor, JniHandleOwnership.DoNotTransfer);
			__this.GetFriendList (count, page, nextCursor);
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.twitter']/class[@name='Twitter']/method[@name='getFriendList' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='java.lang.String']]"
		[Register ("getFriendList", "(IILjava/lang/String;)V", "GetGetFriendList_IILjava_lang_String_Handler")]
		protected override unsafe void GetFriendList (int count, int page, string nextCursor)
		{
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.twitter']/class[@name='Twitter']/method[@name='initDevInfo' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.twitter']/class[@name='Twitter']/method[@name='setNetworkDevinfo' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.twitter']/class[@name='Twitter']/method[@name='timeline' and count(parameter)=3 and parameter[1][@type='int'] and parameter[2][@type='int'] and parameter[3][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.twitter']/class[@name='Twitter']/method[@name='userInfor' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
