...
namespace CN.Sharesdk.Wechat.Utils {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMusicObject']"
	[global::Android.Runtime.Register ("cn/sharesdk/wechat/utils/WXMusicObject", DoNotGenerateAcw=true)]
	public partial class WXMusicObject : global::Java.Lang.Object, global::CN.Sharesdk.Wechat.Utils.WXMediaMessage.IMediaObject {



		// Metadata.xml XPath field reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMusicObject']/field[@name='musicDataUrl']"
		[Register ("musicDataUrl")]
		public string MusicDataUrl {
			get {
				const string __id = "musicDataUrl.Ljava/lang/String;";
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMusicObject']/field[@name='musicLowBandDataUrl']"
		[Register ("musicLowBandDataUrl")]
		public string MusicLowBandDataUrl {
			get {
				const string __id = "musicLowBandDataUrl.Ljava/lang/String;";
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMusicObject']/field[@name='musicLowBandUrl']"
		[Register ("musicLowBandUrl")]
		public string MusicLowBandUrl {
			get {
				const string __id = "musicLowBandUrl.Ljava/lang/String;";
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMusicObject']/field[@name='musicUrl']"
		[Register ("musicUrl")]
		public string MusicUrl {
			get {
				const string __id = "musicUrl.Ljava/lang/String;";
		...
		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("cn/sharesdk/wechat/utils/WXMusicObject", typeof (WXMusicObject));
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMusicObject']/constructor[@name='WXMusicObject' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
...
#pragma warning disable 0169
		...
		{
			global::CN.Sharesdk.Wechat.Utils.WXMusicObject __this = global::Java.Lang.Object.GetObject<global::CN.Sharesdk.Wechat.Utils.WXMusicObject> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.CheckArgs ();
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMusicObject']/method[@name='checkArgs' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMusicObject']/method[@name='serialize' and count(parameter)=1 and parameter[1][@type='android.os.Bundle']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMusicObject']/method[@name='type' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMusicObject']/method[@name='unserialize' and count(parameter)=1 and parameter[1][@type='android.os.Bundle']]"
