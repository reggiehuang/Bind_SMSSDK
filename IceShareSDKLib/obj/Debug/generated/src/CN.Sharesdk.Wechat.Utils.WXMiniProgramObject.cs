...
namespace CN.Sharesdk.Wechat.Utils {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMiniProgramObject']"
	[global::Android.Runtime.Register ("cn/sharesdk/wechat/utils/WXMiniProgramObject", DoNotGenerateAcw=true)]
	public partial class WXMiniProgramObject : global::Java.Lang.Object, global::CN.Sharesdk.Wechat.Utils.WXMediaMessage.IMediaObject {


		// Metadata.xml XPath field reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMiniProgramObject']/field[@name='MINIPROGRAM_TYPE_PREVIEW']"
		[Register ("MINIPROGRAM_TYPE_PREVIEW")]
		public const int MiniprogramTypePreview = (int) 2;

		// Metadata.xml XPath field reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMiniProgramObject']/field[@name='MINIPROGRAM_TYPE_TEST']"
		[Register ("MINIPROGRAM_TYPE_TEST")]
		public const int MiniprogramTypeTest = (int) 1;

		// Metadata.xml XPath field reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMiniProgramObject']/field[@name='MINIPTOGRAM_TYPE_RELEASE']"
		[Register ("MINIPTOGRAM_TYPE_RELEASE")]
		public const int MiniptogramTypeRelease = (int) 0;


		// Metadata.xml XPath field reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMiniProgramObject']/field[@name='miniprogramType']"
		[Register ("miniprogramType")]
		public int MiniprogramType {
			get {
				const string __id = "miniprogramType.I";
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMiniProgramObject']/field[@name='path']"
		[Register ("path")]
		public string Path {
			get {
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMiniProgramObject']/field[@name='userName']"
		[Register ("userName")]
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMiniProgramObject']/field[@name='webpageUrl']"
		[Register ("webpageUrl")]
		public string WebpageUrl {
			get {
				const string __id = "webpageUrl.Ljava/lang/String;";
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMiniProgramObject']/field[@name='withShareTicket']"
		[Register ("withShareTicket")]
		public bool WithShareTicket {
			get {
				const string __id = "withShareTicket.Z";
		...
		internal    new     static  readonly    JniPeerMembers  _members    = new XAPeerMembers ("cn/sharesdk/wechat/utils/WXMiniProgramObject", typeof (WXMiniProgramObject));
		...
		protected WXMiniProgramObject (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		// Metadata.xml XPath constructor reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMiniProgramObject']/constructor[@name='WXMiniProgramObject' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe WXMiniProgramObject ()
...
#pragma warning disable 0169
		...
		{
			global::CN.Sharesdk.Wechat.Utils.WXMiniProgramObject __this = global::Java.Lang.Object.GetObject<global::CN.Sharesdk.Wechat.Utils.WXMiniProgramObject> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			return __this.CheckArgs ();
		}
#pragma warning restore 0169

		// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMiniProgramObject']/method[@name='checkArgs' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMiniProgramObject']/method[@name='serialize' and count(parameter)=1 and parameter[1][@type='android.os.Bundle']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMiniProgramObject']/method[@name='type' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='cn.sharesdk.wechat.utils']/class[@name='WXMiniProgramObject']/method[@name='unserialize' and count(parameter)=1 and parameter[1][@type='android.os.Bundle']]"
